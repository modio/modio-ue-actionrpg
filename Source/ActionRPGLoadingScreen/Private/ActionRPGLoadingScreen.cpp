...
#else
			TObjectPtr<UObject> CachedResourceObjectPtr = CachedResourceObject;
			Collector.AddReferencedObject(CachedResourceObjectPtr);
#endif
		}
	}
...
public:
	...
	SRPGLoadingScreen() = default;
	SRPGLoadingScreen(SRPGLoadingScreen&&) = delete;
	SRPGLoadingScreen& operator = (SRPGLoadingScreen&&) = delete;
