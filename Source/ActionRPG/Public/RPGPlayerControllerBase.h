...
public:
	...
	/** Adds a new inventory item, will add it to an empty slot if possible. If the item supports count you can add more
	 * than one count. It will also update the level when adding if required */
