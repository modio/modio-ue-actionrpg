...
== Project Telemetry
This project includes *Sentry* to help us automatically capture crashes, errors, and performance issues. This telemetry allows us to improve stability, diagnose problems more quickly, and better support developers using the project.

If you prefer not to send telemetry, you can completely remove Sentry from your build by deleting the dependency block in https://github.com/modio/modio-ue-actionrpg/blob/main/Source/ActionRPG/ActionRPG.Build.cs#L62[Source/ActionRPG/ActionRPG.Build.cs]. 
...
After this change, Sentry will no longer be linked or initialized for any platform, and no telemetry will be sent.
